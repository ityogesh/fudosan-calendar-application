class Constants {
  ...
  static const String base_URL = 'http://106.51.49.160:9093/api';
  ...
  static const String forgot_password_Change_URL = base_URL + '/forgot_password';
  static const String otp_Resend = base_URL + '/email_otp_resend';
}
